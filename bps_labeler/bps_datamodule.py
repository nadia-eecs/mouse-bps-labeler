...
class BPSDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self) -> TRAIN_DATALOADERS:
        ...
        """
        return DataLoader(self.bps_training, self.batch_size, self.num_workers)
    
    def val_dataloader(self) -> EVAL_DATALOADERS:
        """
        Returns the validation dataloader.
        """
        return DataLoader(self.bps_validate, self.batch_size, self.num_workers)
    def test_dataloader(self) -> EVAL_DATALOADERS:
        ...
        """
        return DataLoader(self.bps_test, self.batch_size, self.num_workers)
